...
Notes:
    ...
    parameters:
        -nofc             Disable secure messaging (fNoSmsg)
        -debugfc          Show extra debug messages (fDebugSmsg)
        -fcscanchain      Scan the block chain for public key addresses on startup
    ...
    Address Whitelist
        ...
        Saved to smsg.ini
        Modify options using the fclocalkeys rpc command or edit the smsg.ini file (with client closed)
